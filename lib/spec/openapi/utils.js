  ...
  switch (container) {
    ...
    case 'query':
      toOpenapiProp = function (propertyName, jsonSchemaElement) {
        ...
        if (jsonSchemaElement.consume) {
          result.content = {
            [jsonSchemaElement.consume]: {
              schema: {
                ...jsonSchemaElement,
          ...
          delete result.content[jsonSchemaElement.consume].schema.consume
          delete result.content[jsonSchemaElement.consume].schema.rawRequired
        } else {
