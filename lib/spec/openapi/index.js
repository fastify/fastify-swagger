...
module.exports = function (opts, cache, routes, Ref) {
  ...
  return function (opts) {
    ...
    // the schemas with an `$id` nested in the route schemas (eg. TypeBox
    // recursive types) are referenced as `#/components/schemas/def-N`:
    // they must be emitted as well
    Object.assign(openapiObject.components.schemas, prepareOpenapiSchemas(defOpts, ref.inlineDefinitions, ref, hoisted))
