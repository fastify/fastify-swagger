...
module.exports = function (opts, cache, routes, Ref) {
  ...
  return function (opts) {
    ...
    // recursive types) are referenced as `#/definitions/def-N`:
    // they must be emitted as well
    Object.assign(swaggerObject.definitions, prepareSwaggerDefinitions(ref.inlineDefinitions, ref, hoisted))
