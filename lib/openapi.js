...
const { formatParamUrl } = require('./dynamicUtil')
    ...
    for (const route of routes) {
      ...
      if (schema) {
        ...
        if (schema.querystring) {
          getCommonParams('query', parameters, schema.querystring, ref, swaggerObject.components.schemas)
        }
        ...
        if (schema.params) {
          getCommonParams('path', parameters, schema.params, ref, swaggerObject.components.schemas)
        }

        if (schema.headers) {
          getCommonParams('header', parameters, schema.headers, ref, swaggerObject.components.schemas)
        }
