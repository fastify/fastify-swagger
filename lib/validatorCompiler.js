...
const binaryValidation = async (data) => {
  return openAjv({ format: 'binary', type: 'string' }, data)
}

const byteValidation = async (data) => {
  return openAjv({ format: 'byte', type: 'string' }, data)
}

const int64bitValidation = async (data) => {
  return openAjv({ format: 'int64', type: 'integer' }, data)
}

const int32bitValidation = async (data) => {
